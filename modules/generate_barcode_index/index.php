...
<?php
                            ...
                            <div class="form-group">
                                <label for="code" class="control-label "> Item  ID</label>
                                <input class="form-control" name="code" type="text" value="<?php echo $stockId;?>" id="code" readonly >
                            </div>
     ...
     <form action="upload.php"
           ...
           <!-- <input type="submit" 
                  ...
                  value="Upload"> -->
                            ...
                            <div class="form-group">
                                <label for="stockId" class="control-label "> Item  ID</label>
                                <input class="form-control" name="stockId" type="text" value="<?php echo $stockId;?>" id="stockId" readonly >
                            </div>       

          <button type="submit" name="submit" value="Upload" class=" btn-block btn btn-success btn-sm" id="upload">Upload To Database</button>
