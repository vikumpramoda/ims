...
$selectUser = "SELECT `member_id`, `NIC`, `first_name`, `last_name`, `DOB`, `address`, 
	`member-category_id`, `User_name`, `Password`, `last_login`, `email`
	FROM `member`
              ...
              <div class="col-lg-6">
                <form>
                  <div class="form-group">
                    ...
                    <input class="form-control" id="exampleInputEmail1" type="email" aria-describedby="emailHelp" placeholder="E-Mail Address"><small class="form-text text-muted" id="emailHelp">We'll never share your email with anyone else.</small>
                  </div>
                  <div class="form-group">
