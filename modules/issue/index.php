            ...
            <div class="tile">
                <div class="row">
                    ...
                    <div class="col-lg-11">
                        ...
                        <button class="btn btn-primary btn-lg " type="submit" onclick="pending()" >Issue</button>
                        <button class="btn btn-success btn-lg" type="submit" onclick="approved()">Request</button>
