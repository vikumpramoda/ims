...
$query = "SELECT m.first_name , g.grn_id,g.grn_date,g.invoice 
          FROM grn g
          INNER JOIN member m on m.member_id = g.member_id
          where g.depot_id= $depot_id ORDER BY grn_id DESC";
...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-th-list"></i> New GRN Table</h1>
        </div>
        ...
        <div class="col-md-12">
            <div class="tile">
                ...
                <tr>
                    ...
                    <th width="20%">GRN ID</th>
                    <th width="20%">Invoice Number</th>
                    <th >GRN Issue Officer</th>
                    <th >Date</th>
                ...
                while($row = mysqli_fetch_array($result))
                {
                    ...
                    <tr>
                        ...
                        <td><input type="button" name="view" value="Details" id="<?php echo $row["grn_id"]; ?>" class="btn btn-info btn-xs view_data" /></td>
                    </tr>
                    <?php
                }
                ?>
