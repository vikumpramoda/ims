<?php
//receiptOrder - Stores Requisition 
    ...
    <div class="container">
                        ...
                        <form method="post" id="user_form">
                            ...
                            <div class="form-group">
                                <label for="rq">Requisition Number</label>
                                <input class="form-control" name="rq" id="rq" type="text" placeholder="Requisition Number" required >
                            </div>
                            ...
                            <div class="form-group">
                                <label for="bookCatol">Request From</label>
